              ...
              <form className="mt-10 space-y-6" onSubmit={(e) => e.preventDefault()}>
                <div className="grid gap-6 sm:grid-cols-2">
                  <div className="space-y-2">
                    <label className="text-[13px] font-bold text-slate-800">Nombre completo</label>
                    <Input placeholder="Ej. Juan Pérez" className="h-12 bg-slate-50/50 border-slate-200 rounded-xl" />
                  </div>
                  <div className="space-y-2">
                    <label className="text-[13px] font-bold text-slate-800">Correo electrónico</label>
                    <Input type="email" placeholder="profesional@empresa.com" className="h-12 bg-slate-50/50 border-slate-200 rounded-xl" />
                  </div>
                </div>
                ...
                <div className="grid gap-6 sm:grid-cols-2">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input type="password" className="h-12 bg-slate-50/50 border-slate-200 rounded-xl" />
                  </div>
                </div>
